...
class QParser
{
  ...
  private function phraseExtract(&$arr_phrase, $str_query = '')
  {
    ...
    preg_match_all('@(".+?")@i', !empty($str_query) ? $str_query : $this->keyword_query, $_phrase_matches);
  ...
  public final function parse()
  {
    ...
    preg_match_all('@([a-z0-9_.]+:[^:]+[^a-z0-9_.:])@i', $this->keyword_query . ' ', $_qualifier_matches);
